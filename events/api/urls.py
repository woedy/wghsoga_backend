...
from events.api.views import add_event, admin_get_all_events_view, edit_event, get_all_events_view, get_event_details_view, archive_event, \
    delete_event, post_event, unarchive_event, get_all_archived_events_view, add_event_images, add_event_videos, add_event_attendee
...
urlpatterns = [
    ...
    path('edit-event/', edit_event, name="edit_event"),
        path('post-event/', post_event, name="post_event"),
    path('add-event-attendee/', add_event_attendee, name="add_event_attendee"),
    ...
    path('admin/get-all-events/', admin_get_all_events_view, name="admin_get_all_events_view"),
